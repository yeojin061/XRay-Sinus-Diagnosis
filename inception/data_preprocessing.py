...
def load_dataset_binary(base_dir, img_size):
    images = []
    labels_left = []
    labels_right = []
    ...
    for label_type in ['negative', 'positive']:
        ...
        for file_name in os.listdir(dir_path):
            ...
            labels_left.append(0 if int(left_label) == 0 else 1)
            labels_right.append(0 if int(right_label) == 0 else 1)
...
def preprocess_binary_data(images, labels_left, labels_right, num_classes=2):
